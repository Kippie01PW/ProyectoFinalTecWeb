...
function realizarActualizacion(tipo, valor) {
    ...
    formData.append('alumno_id', window.ALUMNO_ID);
    ...
    fetch('/ProyectoFinalTecWeb/app/Controllers/Alumno_actu.php', {
        method: 'POST',
        body: formData
    })
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title fw-bold">Confirmar Actualización</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-success" id="confirmarBtn">Actualizar</button>
                    </div>
                </div>
            </div>
        </div>
